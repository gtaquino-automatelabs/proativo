...
from .endpoints import health, chat, feedback, fallback_demo, cache_demo, metrics_export, fallback_monitoring
...
def create_app() -> FastAPI:
    ...
    app.include_router(fallback_monitoring.router, prefix="/api/v1", tags=["Fallback Monitoring"])
